...
class ModelInstance
{
    ...
    double scaling_factor;      ///< uniform scaling factor同一缩放.
	...
	BoundingBoxf3 transform_mesh_bounding_box(TriangleMesh* _mesh, bool dont_translate = false, bool old = true) const;
